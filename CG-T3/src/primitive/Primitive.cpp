...
void Primitive::addTextureVertex(Vertex3D* vertex)
{
    this->textureVertexList.push_back(vertex);
}

std::vector<Vertex3D*>* Primitive::getTextureVertexList()
{
    return &this->textureVertexList;
}
        ...
        case 3:
        {
            ...
            if(hasTexture())
            {
                glBegin(glPrimitive);
                    ...
                    glTexCoord2d(textureVertexList.at(0)->getX(), textureVertexList.at(0)->getZ());
                    glVertex3d(v0->getX(), v0->getY(), v0->getZ());

                    glNormal3d(normalVector.getX(), normalVector.getY(), normalVector.getZ());
                    glTexCoord2d(textureVertexList.at(1)->getX(), textureVertexList.at(1)->getZ());
                    glVertex3d(v1->getX(), v1->getY(), v1->getZ());

                    glNormal3d(normalVector.getX(), normalVector.getY(), normalVector.getZ());
                    glTexCoord2d(textureVertexList.at(2)->getX(), textureVertexList.at(2)->getZ());
        ...
        case 4:
        {
            ...
            if(hasTexture())
            {
                ...
                glBegin(glPrimitive);
                    ...
                    glNormal3d(normalVector.getX(), normalVector.getY(), normalVector.getZ());
                    glTexCoord2d(textureVertexList.at(3)->getX(), textureVertexList.at(3)->getZ());
