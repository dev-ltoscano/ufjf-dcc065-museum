...
Material::~Material()
{
    ...
    delete white_ambient;
    delete white_diffuse;
    delete white_specular;
    delete white_shininess;
}
...
{
    setObjectMaterial(white_ambient, white_diffuse, white_specular, white_shininess);
}
